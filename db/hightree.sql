...
--
-- Host: localhost:3306
-- Generation Time: Apr 25, 2020 at 10:37 AM
...
(15, 'buyer success registration message', '<p>\r\n मेरो नाम सागर चापागाई हो । म नक्खुमा बस्छु </p>\r\n', 'buyer-success-registration-message', 'success message', 'success message', 'success message', 'Yes', '2016-08-05 11:56:53', '2018-06-26 01:59:19', 'Yes');
...
(2, '2018-07-05 06:03:52', 'Admin Login', 'saagarchapagain@gmail.com', 'ePPkJl1c1xeJ5yh/5m7WGG5XG1Z41lCrW3JdWv+XOoh1S/agcdCsKnRk0cfJGjy+YEj3OxiGEApGnytH6anl4w==', '::1', 'Linux', 'Chrome | 67.0.3396.87', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.87 Safari/537.36', 'http://localhost/thehightree/admin', 'Admin user not registered', ''),
(3, '2018-07-05 06:04:00', 'Admin Login', 'admin', 'XatvUY30+v5+DBemV/RQd+lBpu7Fe9R7akdTGpAIi0TYdsn/CMmQS/sSK2fpWzY7JmzK5CMa6BRYKGRZ6pvEiw==', '::1', 'Linux', 'Chrome | 67.0.3396.87', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/67.0.3396.87 Safari/537.36', 'http://localhost/thehightree/admin', 'invalid password', ''),
(4, '2019-02-05 03:54:12', 'Admin Login', 'admin', 'Oh4ACIGn7v/Un91nQYrFXKJXqvOSrDaHOsEJnQwv7CE25keLIDfq8w55AdKffRLs9my+nndY6rY+Jqx+lmqpmA==', '::1', 'Linux', 'Chrome | 71.0.3578.98', 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/71.0.3578.98 Safari/537.36', 'http://localhost/thehightree/admin', 'invalid password', '');
...
(1, 'sujit@emultitechsolution.com', '', 'admin', '608b6f1f646f7b694d363a62dda1de2c552c650b', '39c2415b70', '1', 0.00, '2014-04-24 12:30:45', '2019-02-04 22:09:24', '2016-07-07 06:13:30', '::1', '::1', '1', '1', '2019-02-05 03:54:24', 1, 0, '', '2016-06-13 17:36:35', '', '', '0000-00-00 00:00:00'),
...
CREATE TABLE `emts_product_categories` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `emts_site_settings` (
  ...
  `copyright_info` varchar(150) COLLATE utf8_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
INSERT INTO `emts_site_settings` (`id`, `site_name`, `log_admin_activity`, `log_admin_invalid_login`, `contact_email`, `contact_name`, `system_email_name`, `system_email`, `address1`, `address2`, `city`, `state`, `zip_code`, `country_name`, `site_status`, `user_activation`, `supplier_category_limit`, `facebook`, `facebook_app_id`, `twitter`, `rss_url`, `linkedin`, `google_plus`, `currency_sign`, `currency_code`, `google_analytics_code`, `auction_post_activation`, `no_auction_post_free`, `is_auction_post_cost`, `no_bid_place_free`, `is_bid_place_cost`, `enable_rating`, `timezone`, `sms_notification`, `sms_gateway_url`, `sms_api_username`, `sms_api_password`, `phone_no`, `skype`, `address`, `copyright_info`) VALUES
(1, 'www.thehightreegroup.com', 'N', 'Y', 'support@thehightreegroup.com', 'The High Tree Group', 'The High Tree Group', 'support@thehightreegroup.com', '', '', '', '', '', '', '1', '0', 5, 'http://www.facebook.com/', 405264519614040, '', 'http://www.rss.com/bidcy', 'http://www.linkedin.com/', '', 'US$', 'USD', '', '1', 5, '0', 5, '1', 'Yes', 'Europe/London', '0', 'http://testapi.comm', 'apiuser', 'apipassword', NULL, NULL, NULL, NULL);
