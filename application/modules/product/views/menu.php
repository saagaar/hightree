...
<h2 class="ttl">Product</h2>
    <li <?php echo (@$current_menu == 'all_product')?'class="active"':''?>>
    	<a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/product/index');?>"><span>List All Products</span></a>
    </li>
    ...
    <li class="active">
       	<a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/product/edit_product/'.$this->uri->segment(4));?>"><span>Edit Product</span></a>
  	</li>
  	<?php } ?>
    
   <h2 class="ttl">Product Type</h2>
