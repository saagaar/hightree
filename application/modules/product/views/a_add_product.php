            ...
            <ul class="subcategoryexpertise">
                  ...
                  <span class="glyphicon glyphicon-plus"></span>
                          <?php 
                            ...
                            ?>
                              <input type="checkbox" name="categories[]" class="" value="<?php echo $category['id'] ?>" class="cat<?php echo $category['id'] ?>"  />
                            <?php 
                            }
                             echo $category['name']; 
                            ?>
                                      ...
                                      { 
                                        ?> <ul>
                                              <?php foreach($category['subcat'] as $subcat){?>
                                                  <li>
                                                      <input type="checkbox" class="" name="categories[]" value="<?php echo $subcat['id'] ?>" class="subcat<?php echo $subcat['parent_id']; ?>"  ><?php echo $subcat['name']; ?>
                                                  </li>
                                              <?php } ?>
                                          </ul>
                                        <?php 
            ...
            <?php if(isset($static_field['auction_start_time']) && $static_field['auction_start_time']['display']=='1'){ ?>
              <li>
                <div>
                  ...
                  <input size="50" class="inputtext datetimepickerwithmindate"  type="text" name="auction_start_time" value="<?php echo set_value('auction_start_time'); ?>">
            ...
            <?php if(isset($static_field['auction_end_days']) && $static_field['auction_end_days']['display']=='1'){ 
              ...
              <li >
                <div>                    
                  ...
                  <input  type="text" name="auc_end_days" class="inputtext select_3_in_one auc_end" value="<?php echo set_value('auc_end_days'); ?>">
                  <?php echo form_error('auc_end_days'); ?>
                   <input  type="text" name="auc_end_hour" class="inputtext select_3_in_one auc_end" value="<?php echo str_pad(set_value('auc_end_hour'),2,0); ?>">
                  <?php echo form_error('auc_end_hour'); ?>
                   <input  type="text" name="auc_end_minute" class="inputtext select_3_in_one auc_end" value="<?php echo str_pad(set_value('auc_end_minute'),2,0); ?>">
