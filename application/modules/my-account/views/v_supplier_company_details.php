...
<div class="col-md-8 col-sm-7">
        	<div class="log-form">
            	<form id="companyDeatailForm" method="post" action="" enctype="multipart/form-data">
					<fieldset>
		            ...
		            <?php } ?>
						<h4><i class="fa fa-user">&nbsp;</i> Personal Details</h4>
							<div class="row">
								...
								<input type="text" name="username" class="form-control" placeholder="Supplier 123" disabled="disabled" value="<?php echo $profile->username; ?>">
								</div>
							</div>
							<div class="row">
								<div class="col-md-6 col-sm-12 form-group">
                            ...
                            <div class="row">
								...
								<input type="text" name="phone" class="form-control" value="<?php echo set_value('phone', $profile->company_phone) ?>">
							...
							<input type="text" name="company_name" class="form-control" placeholder="Supplier  demo company name the high tree group 1234567890.inc" value="<?php echo set_value('company_name', $profile->company_name); ?>">
                         ...
                         <div class="btn-sec"><button id="conpanyDetailEditBtn" type="submit" name="button" class="btn">Submit</button></div>
