                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-6 col-xs-4">
                        ...
                        <ol>
                            ...
                            <li>Budget <span><?php echo $product->budget.' '.$product->currency_sign; ?></span></li>
                            <li>Bid Decrement <span><?php echo $product->bid_decrement.' '.$product->currency_sign; ?></span></li>
...
<div class="col-md-6 col-sm-6 col-xs-8">
                        ...
                        <div class="timer_sec">
                            ...
                            <h3><i class="fa fa-clock-o" aria-hidden="true">&nbsp;</i> Last Bid Amount</h3>
                            ...
                            <div class="clearfix"></div>
                                ...
                                <ul id="">
                                   ...
                                   <?php
                                   if(count($last_bid_amount)>0)
                                    echo $last_bid_amount['0']->user_bid_amt;
                                    else echo 'No Bid Placed';
                                    ?>
        ...
        <div class="col-md-4 col-sm-12">
        	...
        	<div class="live_box">
                ...
                <form id="placeBidForm" method="post" action="<?php echo site_url('bidding/index'); ?>" enctype="multipart/form-data" id="placeBidForm">
                    ...
                    <input type="hidden" id="budget" value="<?php echo $product->budget;?>">
                      <input type="hidden" id="bid_decrement" value="<?php echo $product->bid_decrement;?>">
...
function initializecharts()
{
  ...
  $.getJSON(url, function(jsonData) {
    console.log(jsonData);
        ...
        var options = {
          title: 'Bid amount Vs Date of bidding',
          pointSize: 10,
          curveType: 'function',
          pointShape: 'square',
           colors: ['#795548'],
