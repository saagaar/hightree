...
?>
 ...
 -->
                ...
                <div class="row">
					...
					<input  type="text" name="auc_start_time"  class="form-control datetimepickercurrentdate" value="<?php echo set_value('auc_start_time'); ?>">
                    ...
                    <div class="col-md-6 col-sm-12 form-group row">
								...
								<div class="col-sm-12">
								 <label><?php echo $static_field['auction_end_days']['field_label']."<span>*</span>"; ?></label>
											...
											<div class="col-sm-4">
												<input  type="text" placeholder="days" name="auc_end_days" class="form-control auc_end"  value="<?php echo set_value('auc_end_days'); ?>">
											
												<?php echo form_error('auc_end_days'); ?>
												</div>
												<div class="col-sm-4">
												<input  type="text" name="auc_end_hour"  placeholder="hour" class="form-control auc_end" value="<?php echo str_pad(set_value('auc_end_hour'),2,0); ?>">
							
												<?php echo form_error('auc_end_hour'); ?>
												</div>
												<div class="col-sm-4">
												<input  type="text" name="auc_end_minute" placeholder="minutes" class="form-control auc_end" value="<?php echo str_pad(set_value('auc_end_minute'),2,0); ?>">
...
$('body').on('focus',".datetimepickercurrentdate", function(){
    $(this).datetimepicker({
      dateFormat: "yy-mm-dd",
