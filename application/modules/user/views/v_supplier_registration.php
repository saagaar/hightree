...
<div class="mid-part">
    ...
    <div class=" container">
        <div class="reg-inner">
            <h2>Register as a Supplier on The High Tree Group</h2>
            <p>Join today for free and increase your sales opportunities.</p> 
            <p><strong>Register now it will only take a minute.</strong></p>

            <b>(<em>*</em> ) is mandatory field.</b>

            <div class="log-form">
                <form id="supplier_registration_form" method="post" action="">
                    <fieldset>
                        <?php
                        ...
                        <div class="form-group terms">
                            <input type="checkbox" name="terms_conditions"><span>By proceeding, you agree to the High Tree Group <a href="<?php
                                if ($terms_condition) {
                                    echo site_url('/page/') . '/' . $terms_condition->cms_slug;
                                } else {
                                    echo '#';
                                }
                                ?>">Terms & Conditions</a>.</span><br />
<?php echo form_error('terms_conditions'); ?>
                            <div id="terms_error"></div>
                        </div>

                        <button id="btnSupplierRegistration" type="submit" name="button" class="btn">Register</button>
