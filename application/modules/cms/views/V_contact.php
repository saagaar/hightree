					...
					<fieldset>
						...
						<!-- <h4><i class="fa fa-user">&nbsp;</i> Contact</h4> -->
                         ...
                         <h4><i class="fa fa-info-circle">&nbsp;</i> Contact Details</h4>
                            <p><b><?php echo CONTACT_NAME;?> , <?php echo ADDRESS;?>/ <?php echo CITY;?>,<?php echo STATE;?> <?php echo COUNTRY;?> <a href="mailto:<?php echo CONTACT_EMAIL;?>"><?php echo CONTACT_EMAIL;?></a></b></p>
                            <ul>
                               ...
                               <?php if(SKYPE!=''){ ?> <li><a href="#"><i class="fa fa-skype"></i>  <?php echo SKYPE;?></a></li><?php } ?>
                           </ul>
                           <summary>
                             We'll get back to you within one business day. You can also call us at <?php echo PHONE;?> or Email at <a href="mailto:<?php echo CONTACT_EMAIL;?>"><?php echo CONTACT_EMAIL;?></a>
                           </summary>
