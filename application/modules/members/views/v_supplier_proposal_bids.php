    	...
    	<table class="table table-hover footable">
            ...
            <?php foreach($proposal_bids as $proposal_bid) { ?>
                <tr>
                    ...
                    <td><a href="<?php echo site_url('/'. MY_ACCOUNT. 'auction_detail/'. $proposal_bid->prd_id); ?>">Detail</a><a href="<?php echo site_url('/'. MY_ACCOUNT. 'cancel_bid/'. $proposal_bid->bid_id); ?>"  onclick="return doconfirm()">Cancel Bid</a></td>
                </tr>                
