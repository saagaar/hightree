...
<article id="bodysec" class="sep">
    <div class="wrap">
        ...
        <section class="smfull">
            ...
            <div class="box_block">
                <form name="add_subcat" method="post" action="" accept-charset="utf-8" enctype="multipart/form-data">
                <fieldset>
                      ...
                      <div>
                      	<?php
					  		if($this->input->post('parent_id')){
								$selected_cat = $this->input->post('parent_id',TRUE);
							}else if($parent_id){
					  	...
					  	?>
                       	...
                       	<label>Select Category:</label>
							<?php
								...
								echo form_dropdown('parent_id', $cat_arr , $selected_cat, "id='category'");
                            ?>
                      ...
                      <div>
                        <label>Display ? <span>*</span> :</label>
                        	<input type="radio" name="is_display" value="1" checked="checked" /> Yes
      						<input name="is_display" type="radio" value="0" <?php echo set_radio('is_display', '0'); ?> /> No
                      </div>
                    </li>
                    </ul>
                </fieldset>
                     ...
                     <li>
                      <div>
                        <label>Short Description<span>*</span> :</label>
                         <textarea name="short_desc" cols="34" rows="2" id="short_desc"><?php echo set_value('short_desc');?></textarea>
