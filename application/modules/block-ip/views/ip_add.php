            ...
            <ul class="frm">
              <li>
                <div>
                  ...
                  <input class="inputtext" type="text" id="ip_address" name="ip_address" value="<?php echo set_value('ip_address'); ?>">
                  <?=form_error('ip_address')?>
                </div>
              </li>
              <li>
                <label>Message<span>*</span> :</label>
                <textarea name="message" cols="50" class="inputtext" id="message"><?php echo set_value('message');?></textarea>
                <?=form_error('message')?>
              </li>
            </ul>
          </fieldset>
