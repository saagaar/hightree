  ...
  <div class="hd_sec">
    <h1>
    	<a href="<?php echo site_url(ADMIN_DASHBOARD_PATH) ?>">
    		<img src="<?php echo base_url().ADMIN_IMG_DIR.'logo.png'; ?>" alt="High Tree Group">
    ...
    <ul class="navi">
      <li class="home" <?php if($this->uri->segment(2) == 'dashboard'){ echo 'current'; }?>><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/dashboard/index')?>"><span class="hm">Dashboard</span></a></li>
       ...
       <li <?php if($this->uri->segment(2) == 'cms' OR $this->uri->segment(2) == 'help'){ echo 'class="current"'; }?>>
        ...
        <li <?php if($this->uri->segment(2) == 'bidpackage'){ echo 'class="current"'; }?>><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/bidpackage/index/')?>"> <span>Bidpackage Management</span></a> </li>
        ...
        <li <?php if($this->uri->segment(2) == 'members'){ echo 'class="current"'; }?>><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/members/index/')?>"> <span>Members Management</span></a> </li>
      
      <!-- <li <?php if($this->uri->segment(2) == 'communication'){ echo 'class="current"'; }?>><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/communication/index/')?>"><span>Communication</span></a></li> -->
      ...
      <li <?php if($this->uri->segment(2) == 'product-categories' OR $this->uri->segment(2) == 'product' OR $this->uri->segment(2) == 'custom-fields'){ echo 'class="current"'; }?>>
       	<a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/product/index')?>"><span>Product Manangement</span></a>
        	<ul>
            	<li><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/product-categories/index')?>">Product Category</a></li>
                <li><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/custom-fields/index')?>">Product Form Fields</a></li>
                <li><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/product/index/')?>"> Products</a> </li>
                <!-- <li><a href="<?php //echo site_url(ADMIN_DASHBOARD_PATH.'/product/host_list/')?>"> Host Auctions</a> </li> -->
            </ul>
        </li>
        
         <?php /*?><li <?php if($this->uri->segment(2) == 'won-auctions' OR $this->uri->segment(2) == 'ordered-products'){ echo 'class="current"'; }?>>
         	<a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/won-auctions/index/')?>"><span>Winner management</span></a>
            <ul>
            	<li><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/won-auctions/index')?>">Won Auctions</a></li>
                <li><a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/ordered-products/index/')?>">Ordered Products</a> </li>
            </ul>
        </li><?php */?>
         
         <li <?php if($this->uri->segment(2) == 'report'){ echo 'class="current"'; }?>>
       	<a href="<?php echo site_url(ADMIN_DASHBOARD_PATH.'/report/index')?>"><span>Report Module</span></a>
        	<ul>
...
<footer id="ftr_sec">
  <p> <!-- &copy; <?php //echo date('Y'); ?> --> <?php echo FOOTER_MESSAGE?> </p>
</footer>
</body>
</html>