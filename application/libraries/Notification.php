...
class Notification
{
	...
	public function send_email_notification($email_template_id, $user_id, $sender_email, $receiver_email, $cc='', $bcc='', $parse_element=array(), $attachments=array() ){
