...
var CalPosOffsetX = -185; //X position offset relative to calendar icon, can be negative value
...
var imageFilesPath = FilesFolderPath+"Image/"; //Path of date time picker image files relative to HTML page.
